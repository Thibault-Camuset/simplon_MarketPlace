...
La Wii a marqué un tournant dans l'histoire du jeu vidéo en ouvrant ce loisir à un public plus large, ciblant ainsi l'ensemble de la société, ce qui explique en partie son succès.","La Wii (prononcez 'Oui') est la dernière console de salon Nintendo en date. Elle a ouvert une nouvelle ère dans le divertissement. Cela fait des années que la popularité, mais aussi la complexité des jeux vidéo grandit. Avec la Wii, Nintendo transforme le jeu en maximisant l'amusement et en minimisant les tracas.
Wii avec Wiimote
Console Wii avec la télécommande Wii Plus.
Un look épuré
...
Des contrôle révolutionnaires
La télécommande Wii Plus sans fil sensible au mouvement, au fonctionnement intuitif, permet de jouer plus naturellement. Cette manette ergonomique reconnaît les mouvements que vous effectuez dans la vie de tous les jours. Vous tapez sur un tambour, vous essayez de frapper une balle avec une raquette de tennis ou une batte de base-ball… Pourquoi appuyer sur un bouton pour reproduire ces mouvements ? Avec la télécommande Wii, il vous suffit de bouger normalement pour jouer.
Nintendo a voulu faire de la télécommande Wii la première manette de jeu universelle. Dans un jeu de combat, c’est une épée, dans un jeu de course c’est un volant… C’est à la fois votre pinceau, votre club de golf et votre avion, mais c’est surtout la clé qui vous donne accès à un monde de divertissement auquel vous n’aviez jamais osé rêver.
Encore plus immersif avec le Nunchuk
Connectez le Nunchuk à la télécommande Wii Plus et tenez-vous prêt. Vous venez de vous immerger dans un nouveau monde où le jeu prend enfin tout son sens. Vous obtenez ainsi deux appareils à la précision remarquable. Ils deviennent votre épée et votre bouclier pour défendre Hyrule dans The Legend of Zelda: Twilight Princess. Ce sont les armes qui vous permettent de vous frayer un chemin dans les corridors exigus de Metroid Prime 3: Corruption et le monde souterrain hostile de Red Steel. ","Nintendo")
("4021628738355","Nintendo Switch","La Nintendo Switch (ニンテンドースイッチ, Nintendō Suitchi?) est une console de jeux vidéo produite par Nintendo, succédant à la Wii U. Il s'agit de la première console hybride, c'est-à-dire multi modes, mise en vente de l'histoire7, pouvant aussi bien faire office de console de salon que de console portable. Annoncée le 17 mars 2015 au cours d'une conférence de presse, présentée officiellement le 20 octobre 2016 et montrée plus en détail le 17 janvier 2017 lors d'une présentation en direct, elle est sortie mondialement le 3 mars 2017.","Nintendo Switch avec paire de Joy-Con Rouge Néon et Bleu Néon
...
("4021608738351","Nintendo DS Lite","La Nintendo DS (ニンテンドーDS, Nintendō Dī Esu?, DS pour Dual Screen, Double Screen au Japon), est une console portable créée par Nintendo, sortie fin 2004 au Japon et en Amérique du Nord et en 2005 en Europe.
